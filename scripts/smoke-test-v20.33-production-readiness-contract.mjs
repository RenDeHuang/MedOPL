...
const scriptPath = "scripts/check-v20.33-production-readiness.mjs";
...
mustMatch(source, /\bRUN_V20_33_PRODUCTION_READINESS\b/, "production_readiness_must_be_opt_in");
mustMatch(source, /env\(["']RUN_V20_33_PRODUCTION_READINESS["']\)\s*!==\s*["']1["']/, "production_readiness_must_require_run_flag_equal_1");
mustMatch(source, /\bV20_33_FULL_LOOP_EVIDENCE_FILE\b/, "production_readiness_must_require_full_loop_evidence_file");
mustMatch(source, /\bV20_33_EXPECTED_BUILD_TAG\b/, "production_readiness_must_accept_expected_build_tag");
mustMatch(source, /opl-v20\.33/, "production_readiness_must_default_to_v20_33_build_tag");
mustMatch(source, /\bV20_33_PRODUCTION_HOSTS_CONFIRMED\b/, "production_readiness_must_require_fixed_production_host_confirmation");
mustMatch(source, /\bV20_33_ROLLBACK_PLAN_CONFIRMED\b/, "production_readiness_must_require_rollback_plan_confirmation");
...
mustNotMatch(source, /portal-v20-33\.\$\{baseDomain\}/, "production_readiness_must_not_require_new_portal_dns");
mustNotMatch(source, /opl-v20-33\.\$\{baseDomain\}/, "production_readiness_must_not_require_new_opl_dns");
...
console.log(JSON.stringify({
  ok: true,
  contract: "v20.33_production_readiness_static",
  scriptPath,
}, null, 2));
