...
const liveScriptPath = "scripts/live-test-v20.33-portal-opl-message-loop.mjs";
...
mustMatch(source, /\bRUN_V20_33_LIVE\b/, "live_script_must_reference_run_v20_33_live");
mustMatch(source, /env\(["']RUN_V20_33_LIVE["']\)\s*!==\s*["']1["']/, "live_script_must_require_run_v20_33_live_equal_1");
mustMatch(source, /\bV20_33_PORTAL_BASE_URL\b/, "live_script_must_accept_v20_33_portal_base_url");
mustMatch(source, /\bV20_33_OPL_BASE_URL\b/, "live_script_must_accept_v20_33_opl_base_url");
...
mustMatch(source, /V20_33_ISOLATED_TRANSPORT_CONFIRMED/, "live_script_must_require_isolated_transport_confirmation");
mustMatch(source, /\bassertFixedHostsAndIsolatedTransport\b/, "live_script_must_validate_fixed_hosts_and_isolated_transport");
mustMatch(source, /\bV20_33_BROWSER_PROXY\b|\b--host-resolver-rules\b/, "live_script_must_support_browser_isolated_transport");
...
mustMatch(
  source,
  /\bV20_33_LOGIN_GATEWAY_RETRIES\b/,
...
assert.doesNotMatch(source, /portal-v20-33\.\$\{baseDomain\}/, "live_script_must_not_require_new_portal_dns");
assert.doesNotMatch(source, /opl-v20-33\.\$\{baseDomain\}/, "live_script_must_not_require_new_opl_dns");
...
console.log(JSON.stringify({
  ok: true,
  contract: "v20.33_portal_opl_message_loop_static",
  liveScriptPath,
}, null, 2));
