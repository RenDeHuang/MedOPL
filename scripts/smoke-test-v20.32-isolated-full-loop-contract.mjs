...
const liveScriptPath = "scripts/live-test-v20.32-isolated-full-loop.mjs";
...
mustMatch(source, /\bRUN_V20_32_FULL_LOOP\b/, "full_loop_gate_must_be_opt_in");
mustMatch(source, /env\(["']RUN_V20_32_FULL_LOOP["']\)\s*!==\s*["']1["']/, "full_loop_gate_must_require_run_flag_equal_1");
...
mustMatch(source, /\bV20_32_ISOLATED_TRANSPORT_CONFIRMED\b/, "full_loop_gate_must_require_isolated_transport_confirmation");
mustMatch(source, /\bV20_32_EXPECTED_BUILD_TAG\b/, "full_loop_gate_must_require_expected_build_tag");
mustMatch(source, /\bverifyPortalBuildTag\b/, "full_loop_gate_must_verify_portal_build_before_mutation");
mustNotMatch(source, /portal-v20-32\.\$\{baseDomain\}/, "full_loop_gate_must_not_require_new_portal_dns");
mustNotMatch(source, /opl-v20-32\.\$\{baseDomain\}/, "full_loop_gate_must_not_require_new_opl_dns");
mustMatch(source, /\bV20_32_CONFIRM_DELETE\b/, "full_loop_gate_must_require_explicit_delete_confirmation");
...
mustMatch(source, /\bV20_32_CONNECT_HOST\b/, "full_loop_gate_must_support_transport_host_override_for_isolated_staging");
mustMatch(source, /\bV20_32_CONNECT_PORT\b/, "full_loop_gate_must_support_transport_port_override_for_isolated_staging");
mustMatch(source, /\bV20_32_ALLOW_INSECURE_TLS\b/, "full_loop_gate_must_require_explicit_insecure_tls_opt_in");
...
mustMatch(source, /\bV20_32_ENV_FILE\b/, "full_loop_gate_must_accept_non_shell_env_file");
...
console.log(JSON.stringify({
  ok: true,
  contract: "v20.32_isolated_full_loop_static",
  liveScriptPath,
}, null, 2));
