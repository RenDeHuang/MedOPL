...
assert.ok(isSmokeClassifiedIn("scripts/smoke-test-v22-real-opl-provider-message-contract-gate.mjs"), "mvp_suite: missing scripts/smoke-test-v22-real-opl-provider-message-contract-gate.mjs");
assert.equal(
