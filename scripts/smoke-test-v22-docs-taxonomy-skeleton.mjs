...
const thisGate = "scripts/smoke-test-v22-docs-taxonomy-skeleton.mjs";
...
assert.deepEqual(await listFilesUnder("tests"), ["README.md"], "tests_skeleton_must_only_contain_readme_until_test_migration");
...
assert(override.commands.includes("node scripts/smoke-test-v22-smoke-eval-boundary.mjs"), "branch_override_must_run_smoke_eval_boundary_gate");
...
assert(override.commands.includes("node scripts/smoke-test-v22-agent-verify-entrypoint.mjs"), "branch_override_must_run_agent_verify_entrypoint");
