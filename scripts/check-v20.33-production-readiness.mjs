...
export function validateFullLoopEvidence(payload, expectedBuildTag = "opl-v20.33") {
...
export async function checkProductionHosts(expectedBuildTag = "opl-v20.33") {
...
if (env("RUN_V20_33_PRODUCTION_READINESS") !== "1") {
  console.log(JSON.stringify({
    ok: true,
    status: "skip",
    reason: "RUN_V20_33_PRODUCTION_READINESS_not_enabled",
    requiredEnv: [
      "RUN_V20_33_PRODUCTION_READINESS",
      "V20_33_FULL_LOOP_EVIDENCE_FILE",
      "V20_33_PRODUCTION_HOSTS_CONFIRMED",
      "V20_33_ROLLBACK_PLAN_CONFIRMED",
...
try {
  assert.equal(boolEnv("V20_33_PRODUCTION_HOSTS_CONFIRMED"), true, "V20_33_PRODUCTION_HOSTS_CONFIRMED_must_be_true");
  assert.equal(boolEnv("V20_33_ROLLBACK_PLAN_CONFIRMED"), true, "V20_33_ROLLBACK_PLAN_CONFIRMED_must_be_true");
  const expectedBuildTag = env("V20_33_EXPECTED_BUILD_TAG", "opl-v20.33");
  const evidenceFile = env("V20_33_FULL_LOOP_EVIDENCE_FILE");
  assert(evidenceFile, "V20_33_FULL_LOOP_EVIDENCE_FILE_required");
  ...
  const payload = {
    ...
    contract: "v20.33_production_readiness",
