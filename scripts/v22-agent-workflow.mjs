...
function buildBoardCurrentTaskPacket(board = {}) {
  return {
    ...
    requiresManualMergeDecision: true,
    suggestedCommands: [
      "node tests/future-authorized/cloud/future-authorized-test-v22-cloud-harness-manifest-selector.mjs",
      "node tests/regression/portal/regression-test-v22-portal-runtime-startup-config.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-cloud-cleanup-local-gate.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-worker-entrypoint.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-async-worker-loop.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-portal-production-cloud-operation-loop.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-portal-production-cloud-operation-resource-lifecycle-loop.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-postgres-canonical-store.mjs",
      "node tests/future-authorized/cloud/future-authorized-test-v22-portal-package-click-cloud-resource-loop.mjs",
      "node tests/smoke/smoke-test-v22-release-stop-billing-audit-flow.mjs",
