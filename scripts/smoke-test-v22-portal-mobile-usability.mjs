...
assertIncludes(workspaceSource, "mobile-card-list", "workspace_must_render_mobile_task_cards");
...
assertIncludes(traceSource, "desktop-table-shell", "trace_table_must_be_desktop_only");
assertIncludes(traceSource, "运行轨迹信息", "trace_copy_must_use_user_language");
