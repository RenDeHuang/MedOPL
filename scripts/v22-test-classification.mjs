...
const LOCAL_RC_FILES = Object.freeze(["tests/local-rc/local-rc-test-v22-provider-bound-message-backflow.mjs"]);
...
const REGISTRY_OVERRIDES = Object.freeze(new Map([
  ...
  ["tests/regression/portal/regression-test-v22-account-wallet-billing-closure.mjs", {"surface":"portal","category":"portal-local","entryKind":"atomic","verifySuites":["local-regression"]}],
  ...
  ["tests/local-rc/local-rc-test-v22-provider-bound-message-backflow.mjs", {"surface":"opl","category":"local-rc-authorized","entryKind":"atomic","verifySuites":["local-rc-authorized"],"ownerSurface":"surface:opl+runtime-bridge"}],
  ...
  ["tests/regression/portal/regression-test-v22-admin-ops-local-projection-view.mjs", {"surface":"portal","category":"portal-local","entryKind":"atomic","verifySuites":["local-regression"]}],
  ...
  ["tests/regression/portal/regression-test-v22-portal-runtime-real-api-data-closure.mjs", {"surface":"portal","category":"portal-local","entryKind":"atomic","verifySuites":["health","local-regression","current","review"]}],
