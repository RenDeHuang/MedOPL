...
const CONTRACT_FILES = Object.freeze(["tests/contract/contract-test-v22-landing-closeout-automation.mjs","tests/contract/contract-test-v22-agent-verify-entrypoint.mjs","tests/contract/contract-test-v22-backend-go-convergence-program.mjs","tests/contract/contract-test-v22-change-package-lifecycle.mjs","tests/contract/contract-test-v22-commercial-package-model.mjs","tests/contract/contract-test-v22-node-portal-backend-physical-removal.mjs","tests/contract/contract-test-v22-go-backend-service-surface.mjs","tests/contract/contract-test-v22-local-portal-opl-delivery-rc.mjs","tests/contract/contract-test-v22-local-service-orchestration.mjs","tests/contract/contract-test-v22-local-saas-backend-rc.mjs","tests/contract/contract-test-v22-precloud-deployable-rc.mjs","tests/contract/contract-test-v22-current-development-lines.mjs","tests/contract/contract-test-v22-current-state-index-loop.mjs","tests/contract/contract-test-v22-diff-scoped-sensitive-hygiene.mjs","tests/contract/contract-test-v22-docs-portfolio-lifecycle.mjs","tests/contract/contract-test-v22-framework-truth-layering.mjs","tests/contract/contract-test-v22-framework-workflow-convergence.mjs","tests/contract/contract-test-v22-product-engineering-loop-index.mjs","tests/contract/contract-test-v22-full-taxonomy-cleanup.mjs","tests/contract/contract-test-v22-golden-smoke-suite.mjs","tests/contract/contract-test-v22-mvp-contract-suite.mjs","tests/contract/contract-test-v22-cleanup-lifecycle-system.mjs","tests/contract/contract-test-v22-review-secret-hygiene-gate.mjs","tests/contract/contract-test-v22-root-verify-workflow-entrypoints.mjs","tests/contract/contract-test-v22-spec-eval-traceability.mjs","tests/contract/contract-test-v22-test-lane-registry.mjs","tests/contract/contract-test-v22-test-lifecycle-cleanup.mjs","tests/contract/runtime-bridge/contract-test-v22-runtime-gate-contract.mjs"]);
const FUTURE_AUTHORIZED_FILES = Object.freeze(["tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-create-release-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-create-release-execution-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-create-release-implementation-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-cloud-cleanup-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-production-cloud-topology-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-real-opl-webui-runtime-bridge-flow.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-deploy-execution-config-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-official-sdk-provider-strategy-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-readonly-inventory-boundary.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-readonly-inventory-official-sdk-shape.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-tc3-diagnostic-cleanup-plan.mjs"]);
...
const REGRESSION_OPL_FILES = Object.freeze(["tests/regression/opl/regression-test-v22-gateway-live-probe.mjs","tests/regression/opl/regression-test-v22-opl-gateway-upstream-proxy-local.mjs","tests/regression/opl/regression-test-v22-opl-web-gateway-direct-entry.mjs","tests/regression/opl/regression-test-v22-opl-web-gateway-launch.mjs","tests/regression/opl/regression-test-v22-opl-web-gateway-native-login.mjs","tests/regression/opl/regression-test-v22-opl-web-gateway-websocket-reset-contract.mjs","tests/regression/opl/regression-test-v22-opl-work-message-file-run-flow.mjs","tests/regression/opl/regression-test-v22-real-opl-file-run-artifact-gates.mjs"]);
const REGRESSION_RUNTIME_BRIDGE_FILES = Object.freeze(["tests/regression/runtime-bridge/regression-test-v22-opl-acp-runtime-bridge.mjs","tests/regression/runtime-bridge/regression-test-v22-opl-runtime-bridge-bootstrap.mjs","tests/regression/runtime-bridge/regression-test-v22-runtime-bridge-local-fake-probe.mjs","tests/regression/runtime-bridge/regression-test-v22-runtime-bridge-state-store-atomic-flow.mjs"]);
const LOCAL_RC_FILES = Object.freeze([]);
