...
const REGISTRY_OVERRIDES = Object.freeze(new Map([
  ...
  ["tests/contract/contract-test-v22-backend-responsibility-inventory.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ...
  ["tests/contract/contract-test-v22-commercial-ui-impact-decision.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-portal-long-task-mutation-boundaries.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-node-portal-workflow-facade-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-service-surface.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-ent-postgres-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-redis-volatile-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-run-file-artifact-domain.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-runtime-broker-interface.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-workflow-facade-command-model.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-go-backend-workflow-routed-command-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
  ["tests/contract/contract-test-v22-node-to-go-migration-map.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","review"]}],
