...
const REGISTRY_OVERRIDES = Object.freeze(new Map([
  ...
  ["tests/future-authorized/cloud/future-authorized-test-v22-package-d-runner-image-publish-workflow-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
