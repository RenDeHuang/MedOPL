...
const CONTRACT_FILES = Object.freeze(["tests/contract/contract-test-v22-landing-closeout-automation.mjs","tests/contract/contract-test-v22-agent-verify-entrypoint.mjs","tests/contract/contract-test-v22-backend-go-convergence-program.mjs","tests/contract/contract-test-v22-backend-responsibility-inventory.mjs","tests/contract/contract-test-v22-commercial-package-model.mjs","tests/contract/contract-test-v22-commercial-ui-impact-decision.mjs","tests/contract/contract-test-v22-portal-long-task-mutation-boundaries.mjs","tests/contract/contract-test-v22-node-portal-workflow-facade-boundary.mjs","tests/contract/contract-test-v22-go-backend-service-surface.mjs","tests/contract/contract-test-v22-go-backend-ent-postgres-boundary.mjs","tests/contract/contract-test-v22-go-backend-redis-volatile-boundary.mjs","tests/contract/contract-test-v22-go-backend-run-file-artifact-domain.mjs","tests/contract/contract-test-v22-go-backend-runtime-broker-interface.mjs","tests/contract/contract-test-v22-go-backend-workflow-facade-command-model.mjs","tests/contract/contract-test-v22-go-backend-workflow-routed-command-boundary.mjs","tests/contract/contract-test-v22-node-to-go-migration-map.mjs","tests/contract/contract-test-v22-current-development-lines.mjs","tests/contract/contract-test-v22-current-state-index-loop.mjs","tests/contract/contract-test-v22-diff-scoped-sensitive-hygiene.mjs","tests/contract/contract-test-v22-docs-portfolio-lifecycle.mjs","tests/contract/contract-test-v22-framework-workflow-convergence.mjs","tests/contract/contract-test-v22-product-engineering-loop-index.mjs","tests/contract/contract-test-v22-full-taxonomy-cleanup.mjs","tests/contract/contract-test-v22-golden-smoke-suite.mjs","tests/contract/contract-test-v22-mvp-contract-suite.mjs","tests/contract/contract-test-v22-cleanup-lifecycle-system.mjs","tests/contract/contract-test-v22-review-secret-hygiene-gate.mjs","tests/contract/contract-test-v22-root-verify-workflow-entrypoints.mjs","tests/contract/contract-test-v22-test-lane-registry.mjs","tests/contract/contract-test-v22-test-lifecycle-cleanup.mjs","tests/contract/runtime-bridge/contract-test-v22-runtime-gate-contract.mjs"]);
...
const REGISTRY_OVERRIDES = Object.freeze(new Map([
  ...
  ["tests/contract/contract-test-v22-commercial-package-model.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-commercial-ui-impact-decision.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-portal-long-task-mutation-boundaries.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-node-portal-workflow-facade-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-service-surface.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-ent-postgres-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-redis-volatile-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-run-file-artifact-domain.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-runtime-broker-interface.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-workflow-facade-command-model.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-go-backend-workflow-routed-command-boundary.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ["tests/contract/contract-test-v22-node-to-go-migration-map.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
