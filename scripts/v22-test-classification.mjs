...
export const HEALTH_CHECK_MAX = 8;
export const SMOKE_GOLDEN_MIN = 8;
export const SMOKE_GOLDEN_MAX = 15;

const HEALTH_FILES = Object.freeze(["tests/health/health-check-v22-contract-conflict-boundary.mjs","tests/health/health-check-v22-line-budget-gate.mjs","tests/health/health-check-v22-repo-hygiene-gate.mjs","tests/health/health-check-v22-smoke-classification-gate.mjs","tests/health/health-check-v22-smoke-eval-boundary.mjs","tests/health/health-check-v22-workflow-gate.mjs","tests/health/health-check-v22-zero-compat-active-surface-gate.mjs"]);
...
const CONTRACT_FILES = Object.freeze(["tests/contract/contract-test-v22-absorb-closeout-automation.mjs","tests/contract/contract-test-v22-agent-verify-entrypoint.mjs","tests/contract/contract-test-v22-current-development-lines.mjs","tests/contract/contract-test-v22-current-state-index-loop.mjs","tests/contract/contract-test-v22-diff-scoped-sensitive-hygiene.mjs","tests/contract/contract-test-v22-docs-portfolio-lifecycle.mjs","tests/contract/contract-test-v22-full-taxonomy-hard-retirement.mjs","tests/contract/contract-test-v22-golden-smoke-suite.mjs","tests/contract/contract-test-v22-mvp-contract-suite.mjs","tests/contract/contract-test-v22-retirement-lifecycle-system.mjs","tests/contract/contract-test-v22-review-secret-hygiene-gate.mjs","tests/contract/contract-test-v22-root-verify-workflow-entrypoints.mjs","tests/contract/contract-test-v22-test-lane-registry.mjs","tests/contract/runtime-bridge/contract-test-v22-runtime-gate-contract.mjs"]);
...
const REGISTRY_OVERRIDES = Object.freeze(new Map([
  ["tests/contract/contract-test-v22-absorb-closeout-automation.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
  ...
  ["tests/contract/contract-test-v22-full-taxonomy-hard-retirement.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract"]}],
  ...
  ["tests/contract/contract-test-v22-retirement-lifecycle-system.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["local-contract","current","review"]}],
