...
const FUTURE_AUTHORIZED_FILES = Object.freeze(["tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-create-release-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-create-release-execution-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-create-release-implementation-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-cloud-cleanup-local-gate.mjs","tests/contract/contract-test-v22-package-d-external-access-edge-nodeport-local-gate.mjs","tests/contract/contract-test-v22-package-d-external-access-healthcheck-local-gate.mjs","tests/contract/contract-test-v22-package-d-external-access-remove-healthcheck-local-gate.mjs","tests/contract/contract-test-v22-package-d-shared-edge-strategy-local-gate.mjs","tests/contract/contract-test-v22-tencent-clb-readonly-diagnostics-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-c-live-canary-readiness-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-c-live-canary-live-runner-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-c-postgres-ledger-sink-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-d-in-cluster-runner-manifest-materialization-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-d-bootstrap-apply-runner-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-d-run-scoped-job-runner-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-d-runner-image-publish-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-package-d-kubernetes-api-preflight-runner-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-production-cloud-topology-contract.mjs","tests/future-authorized/cloud/future-authorized-test-v22-real-opl-webui-runtime-bridge-flow.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-deploy-execution-config-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tencent-resource-lifecycle-dry-run-plan-local-gate.mjs","tests/future-authorized/cloud/future-authorized-test-v22-tke-bootstrap-preflight-local-gate.mjs"]);
...
const REGISTRY_OVERRIDES = Object.freeze(new Map([
  ...
  ["tests/contract/contract-test-v22-validate-active-platform.mjs", {"surface":"control-plane","category":"default/local-contract","entryKind":"gate-self-test","verifySuites":["health","local-contract","current","review"]}],
  ...
  ["tests/contract/contract-test-v22-package-d-external-access-edge-nodeport-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/contract/contract-test-v22-package-d-external-access-healthcheck-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/contract/contract-test-v22-package-d-external-access-remove-healthcheck-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/contract/contract-test-v22-package-d-shared-edge-strategy-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/contract/contract-test-v22-tencent-clb-readonly-diagnostics-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ...
  ["tests/future-authorized/cloud/future-authorized-test-v22-package-d-bootstrap-apply-runner-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/future-authorized/cloud/future-authorized-test-v22-package-d-run-scoped-job-runner-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/future-authorized/cloud/future-authorized-test-v22-package-d-runner-image-publish-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  [ {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
  ["tests/future-authorized/cloud/future-authorized-test-v22-package-d-kubernetes-api-preflight-runner-local-gate.mjs", {"surface":"cloud","category":"cloud-future-authorized","entryKind":"gate-self-test","verifySuites":["cloud-future-authorized"]}],
