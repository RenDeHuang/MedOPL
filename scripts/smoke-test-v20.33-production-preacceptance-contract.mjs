...
const scriptPath = "scripts/live-test-v20.33-production-preacceptance.mjs";
...
mustMatch(/\bRUN_V20_33_PREACCEPTANCE\b/, "preacceptance_must_be_opt_in");
mustMatch(/env\(["']RUN_V20_33_PREACCEPTANCE["']\)\s*!==\s*["']1["']/, "preacceptance_must_require_run_flag_equal_1");
...
mustMatch(/\bV20_33_PREACCEPTANCE_CONTENT_TIMEOUT_MS\b/, "preacceptance_must_wait_for_page_business_text");
...
mustMatch(/V20_33_EXPECTED_BUILD_TAG/, "preacceptance_must_check_expected_build_tag");
...
console.log(JSON.stringify({
  ok: true,
  contract: "v20.33_production_preacceptance_static",
  scriptPath,
}, null, 2));
