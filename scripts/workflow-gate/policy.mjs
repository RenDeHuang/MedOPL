...
export function isStrictMonolithCleanupAuthorizedDelete(filePath, status, branchName = "") {
  ...
  if (branchName === "cleanup/v22-node-backend-physical-removal") {
    return [
      ...
      /^tests\/regression\/portal\/regression-test-v22-(?:account-wallet-billing-closure|admin-ops-disabled-product-state|admin-ops-local-projection-view|managed-resource-binding-plan-view|portal-admin-shared-helper-structure|portal-api-auth-boundary|portal-auth-landing-route|portal-cost-balance-trace-linkage|portal-file-space-management|portal-local-api-action-closure|portal-runtime-startup-config|portal-session-trace-view|portal-storage-mode-local-closure|portal-trace-file-linkage|portal-resource-management-ui-api|workspace-storage-public-response)\.mjs$/u,
