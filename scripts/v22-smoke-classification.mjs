...
export const SMOKE_CLASSIFICATION = Object.freeze({
  ...
  "scripts/smoke-test-v22-docs-taxonomy-skeleton.mjs": "default/local-contract",
  "scripts/smoke-test-v22-opl-style-taxonomy-hard-compaction.mjs": "default/local-contract",
