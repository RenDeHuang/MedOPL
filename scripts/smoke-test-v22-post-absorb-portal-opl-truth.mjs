...
assert(currentLeafManifest.verification_commands.includes("node scripts/smoke-test-v22-portal-storage-mode-local-closure.mjs"), "postgres_redis_leaf_must_subscribe_storage_mode_eval");
...
assert(gapMatrix.includes("node scripts/smoke-test-v22-portal-storage-mode-local-closure.mjs"), "gap_matrix_must_reference_storage_mode_eval");
