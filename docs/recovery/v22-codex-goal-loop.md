...
- Codex 每轮必须读取 `docs/recovery/v22-goal-current.json`，并用 `node tests/contract/contract-test-v22-goal-state-consistency.mjs` 校验 JSON/Markdown/gap/scoreboard 一致。
