...
- RED: `node tests/contract/contract-test-v22-contract-eval-compaction.mjs` 初始失败，缺少 `docs/recovery/v22-contract-eval-compaction-index.md`。
...
- Important finding: truth layer still carried physical cleanup history. Fixed by moving retired stage-file evidence into `docs/recovery/v22-contract-eval-compaction-index.md` and tightening `tests/contract/contract-test-v22-truth-freeze-physical-retirement.mjs`.
