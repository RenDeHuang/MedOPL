...
| active | `services/portal`、`services/opl-web-gateway`、`services/opl-runtime-bridge`、`docs/product.md`、`docs/architecture.md`、`docs/contracts/v22-*`、`docs/recovery/*`、`tests/**/*.mjs` | 可以承载 v22 新产品语义、契约、文档收敛和本地 smoke |
