...
| Portal Web | `services/portal/frontend/src/router/index.ts`、`services/portal/frontend/src/layouts/AppSidebar.vue`、`services/portal/frontend/src/views/overview/OverviewView.vue`、`services/portal/frontend/src/views/packages/PackagesView.vue`、`services/portal/frontend/src/views/resources/ResourcesView.vue`、`services/portal/frontend/src/views/workspace/WorkspaceView.vue`、`services/portal/frontend/src/views/opl/OplLaunchView.vue`、`services/portal/frontend/src/views/billing/BillingView.vue`、`services/portal/frontend/src/views/trace/TraceView.vue`、`services/portal/src/routes/portal-api.routes.mjs`、`services/portal/src/routes/opl.routes.mjs`、`services/portal/src/routes/lab-package.routes.mjs`、`services/portal/src/routes/workspace-storage.routes.mjs` | frontend/admin 中 ops surface 门控要表达租户能力，不要成为产品主叙事 | `services/portal/src/routes/portal-legacy-redirect.routes.mjs` 不属于 active surface；旧 `/portal` 入口不得继续扩写、复用或作为迁移默认入口 | 旧 resource-order 页面/路由叙事不作为 Portal Web 主线 |
