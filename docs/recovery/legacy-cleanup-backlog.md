...
| 8 | Zero-Compat Active Surface Gate | `cleanup/v22-strict-monolith-zero-compat-active-surface` | Zone 1/2/4 | gate/rewrite/delete | 定义 zero-compat gate；Runtime Bridge 旧字段已清退，billing adapter、local Dockerfile 和 live/canary/authorized runner executable surface 已按 Slice K/L/M 清退。 |
