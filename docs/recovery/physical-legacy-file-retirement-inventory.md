...
- slice-2 truth writeback: completed. Static scans found no active/default/workflow refs to v19/v20/v21/live-test script families; v19/v20/v21 smoke families remain archive_reference, and live-test physical delete authorized and completed on 2026-05-14 without running live-test.
...
- final slice truth writeback: completed_waiting_b_review. This batch did not add more deletion in the final slice; remaining blockers are public tombstone auth, schema/drop leaf, forbidden deploy/adapters/infra auth, and Langfuse trace metadata migration boundary.
