...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `services/portal/src/routes/resource-order.routes.mjs` | resource-order | Zone 2 | old public/internal route retired shell | route runtime registration and retirement gate | no default success path | yes | no | no | `delete` | `not_started` | `scripts/smoke-test-v22-strict-monolith-legacy-retirement-gate.mjs --portal` | `cleanup/v22-strict-monolith-ideal-gap-and-legacy-retirement` | delete public retired shell and route registration |
