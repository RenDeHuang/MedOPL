...
- eval: `node tests/contract/smoke-test-v22-default-entry-narrative-gate.mjs`
...
- status: cleaned
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`; store/Postgres/schema physical retirement is covered by the resource-order retirement gate and strict monolith schema gate.
...
- status: cleaned
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/contract/smoke-test-v22-diff-scoped-sensitive-hygiene.mjs`
...
- status: cleaned
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`
- allowed_files: `docs/recovery/*`, `tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`, branch-scoped harness allowlist updates
...
- status: gated
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/regression/portal/smoke-test-v22-portal-structure-failure-isolation-contract.mjs`
- allowed_files: `docs/contracts/v22-portal-structure-failure-isolation-boundary.md`, `docs/recovery/*`, `tests/regression/portal/smoke-test-v22-portal-structure-failure-isolation-contract.mjs`, branch-scoped harness allowlist updates; future implementation refactor branches under `services/portal/**` must be separate leaf steps
...
- status: completed
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/contract/smoke-test-v22-agent-run-record-gate.mjs`; `node tests/regression/portal/smoke-test-v22-portal-frontend-api-surface-alignment.mjs`; `node tests/regression/opl/smoke-test-v22-portal-opl-api-runtime-loop.mjs`; `node tests/regression/portal/smoke-test-v22-portal-trace-file-linkage.mjs`; `node tests/regression/opl/smoke-test-v22-opl-work-message-file-run-flow.mjs`; `node tests/smoke/smoke-test-v22-runtime-bridge-session-run-file-provider-keyref-flow.mjs`; `node tests/smoke/smoke-test-v22-portal-files-billing-trace-flow.mjs`; `node tests/regression/portal/smoke-test-v22-portal-runtime-suite.mjs --group surface`
...
- status: completed
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/future-authorized/cloud/smoke-test-v22-cloud-onboarding-workflow-contract.mjs`
...
- current_fact: The Figma Make user/admin React UI baseline has been absorbed, and this cleanup leaf centralizes remaining retired frontend residue into `tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`.
...
- status: completed
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`; `node tests/regression/portal/smoke-test-v22-portal-workbench-management-ui-composition-contract.mjs`; `node tests/regression/portal/smoke-test-v22-portal-figma-make-ui-implementation-contract.mjs`; `node tests/contract/smoke-test-v22-goal-state-consistency.mjs`
- allowed_files: `DESIGN.md`, `services/portal/frontend/playwright.config.ts`, `docs/contracts/v22-portal-figma-make-ui-implementation-boundary.md`, `docs/contracts/v22-portal-ui-design-quality-audit-boundary.md`, `docs/contracts/v22-portal-workbench-management-ui-composition-boundary.md`, `docs/contracts/README.md`, `docs/recovery/v22-goal-current.json`, `docs/recovery/v22-goal-state.md`, `docs/recovery/v22-current-vs-ideal-gap-matrix.md`, `docs/recovery/v22-agent-verify-manifest.json`, `docs/recovery/mvp-contract-acceptance.md`, `docs/recovery/architecture-truth.md`, `docs/recovery/status-matrix.md`, `docs/recovery/portal-figma-make-ui-convergence-plan.md`, `docs/recovery/portal-ui-design-generation-brief.md`, `docs/recovery/portal-ui-design-prd.md`, `tests/regression/portal/smoke-test-v22-portal-figma-make-ui-implementation-contract.mjs`, `tests/contract/smoke-test-v22-agent-verify-entrypoint.mjs`, `tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`, `tests/contract/smoke-test-v22-goal-state-consistency.mjs`, `tests/contract/smoke-test-v22-mvp-contract-suite.mjs`, `tests/contract/smoke-test-v22-product-goal-execution-order.mjs`, `tests/regression/portal/smoke-test-v22-portal-figma-make-ui-implementation-contract.mjs`, `tests/regression/portal/smoke-test-v22-portal-workbench-management-ui-composition-contract.mjs`
...
- status: completed
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/regression/portal/smoke-test-v22-portal-figma-make-ui-implementation-contract.mjs`; `node tests/regression/portal/smoke-test-v22-portal-ui-design-quality-audit.mjs`; `node tests/regression/portal/smoke-test-v22-portal-runtime-suite.mjs --group surface`; `npm --prefix services/portal/frontend run typecheck`; `npm --prefix services/portal/frontend run build`
- allowed_files: `services/portal/frontend/**`, `DESIGN.md`, `docs/contracts/v22-portal-figma-make-ui-implementation-boundary.md`, `docs/contracts/v22-portal-ui-design-quality-audit-boundary.md`, `docs/contracts/v22-portal-workbench-management-ui-composition-boundary.md`, `docs/contracts/v22-saas-control-plane-user-experience-boundary.md`, `docs/contracts/README.md`, `docs/recovery/v22-goal-current.json`, `docs/recovery/v22-goal-state.md`, `docs/recovery/v22-current-vs-ideal-gap-matrix.md`, `docs/recovery/mvp-contract-acceptance.md`, `tests/regression/portal/smoke-test-v22-portal-figma-make-ui-implementation-contract.mjs`, `tests/regression/portal/smoke-test-v22-portal-runtime-suite.mjs`
...
- status: completed
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/regression/portal/smoke-test-v22-portal-local-api-action-closure.mjs`; `node scripts/v22-verify.mjs current --base origin/recovery/platform-v22-trunk --json`
...
- status: completed
- next_leaf_step: monitor_only_after_B_absorb
- eval: `node tests/regression/portal/smoke-test-v22-workspace-storage-public-response.mjs`; `node tests/contract/smoke-test-v22-agent-run-record-gate.mjs`; `node scripts/v22-verify.mjs current --base origin/recovery/platform-v22-trunk --json`
...
- current_fact: Portal 本地 JSON-mode、可见 API/action closure、workspace 文件动作闭环、Portal-OPL file/run/artifact 本地闭环均已吸收；PostgreSQL/Redis 本地生产数据层还没有实现，但已有 eval shell `tests/regression/portal/smoke-test-v22-portal-storage-mode-local-closure.mjs` 覆盖 schema unique index、migrator 事务边界、postgres_redis fail-closed 和本地正向闭环探测。
...
- eval: `node tests/regression/portal/smoke-test-v22-portal-storage-mode-local-closure.mjs`; `node tests/contract/smoke-test-v22-post-absorb-portal-opl-truth.mjs`; `node scripts/v22-verify.mjs current --base origin/recovery/platform-v22-trunk --json`
...
- allowed_files: `docs/recovery/v22-goal-state.md`, `docs/recovery/v22-current-vs-ideal-gap-matrix.md`, `tests/smoke/smoke-test-v22-release-stop-billing-audit-flow.mjs`, `tests/contract/smoke-test-v22-product-goal-harness.mjs`, `tests/contract/smoke-test-v22-default-entry-narrative-gate.mjs`, `tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs`, and exact branch-scoped harness allowlist updates; future implementation branches must declare a narrower billing/service write set separately.
...
- eval: `node tests/contract/smoke-test-v22-release-readiness-auth-boundary.mjs`; `node scripts/v22-workflow-gate.mjs review --base origin/recovery/platform-v22-trunk`
- allowed_files: docs/recovery and future authorized deploy contracts; current local auth-boundary leaf may add `tests/contract/smoke-test-v22-release-readiness-auth-boundary.mjs` and exact harness allowlist updates only
