...
-> materialize static Package D runner manifest review pack / authorization pack; then run authorized Kubernetes API connectivity and server-side dry-run from the platform runner
