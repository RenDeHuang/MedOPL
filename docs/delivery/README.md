...
-> next gap is authorized rerun `psr-20260617-003` of that service reachability runner plus Portal external access strategy; choose Ingress, LoadBalancer, internal gateway or admin-only port-forward under separate authorization before any public/user access claim
