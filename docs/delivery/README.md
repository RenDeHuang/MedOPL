...
-> separately authorize run-scoped platform runner Job lifecycle with unique `medopl-platform-runner-preflight-<runid>` name, observe/evidence/cleanup only that Job
