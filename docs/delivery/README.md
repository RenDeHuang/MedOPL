...
-> materialize static Package D runner manifest review pack / authorization pack / bootstrap authorization pack; then use the repo-native Package D Kubernetes API dry-run runner from Tencent CloudShell, Cloud Assistant or a VPC internal runner with TKE API reachability
