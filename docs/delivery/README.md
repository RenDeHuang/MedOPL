...
-> next gap is readonly service reachability / in-cluster HTTP smoke plus Portal external access strategy; choose Ingress, LoadBalancer, internal gateway or admin-only port-forward under separate authorization before any public/user access claim
