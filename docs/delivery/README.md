...
-> if namespace missing, authorize bootstrap-only apply for `medopl-platform` Namespace and Package D bootstrap ServiceAccount/RBAC/ConfigMap/SecretRef/imagePullSecret/Job resources; no business Deployment rollout
