...
-> choose in-cluster platform runner on `np-cbk784r8`; keep build/push separate; run Kubernetes API connectivity preflight / PostgreSQL ledger canary / Package D combined preflight from the platform runner
