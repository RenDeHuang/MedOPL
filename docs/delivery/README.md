...
-> next gap is authorized execution of that service reachability runner plus Portal external access strategy; choose Ingress, LoadBalancer, internal gateway or admin-only port-forward under separate authorization before any public/user access claim
