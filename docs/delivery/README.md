...
-> Package D deploy authorization pack recorded in `tests/fixtures/v22/goal-current.json#package_d_deploy_readiness_plan.deployAuthorizationPack`; repo-native production deploy runner single entrypoint is missing and must be implemented before authorized deploy
