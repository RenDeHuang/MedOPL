...
-> publish the fixed Package D runner image tag through GitHub Actions `workflow_dispatch` with protected environment `package-d-image-publish`; no deploy and no TKE/VPC runner Docker build/push
