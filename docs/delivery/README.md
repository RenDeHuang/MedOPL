...
-> if namespace missing, authorize the repo-native Package D bootstrap apply runner for `medopl-platform` Namespace and Package D bootstrap ServiceAccount/RBAC/ConfigMap/SecretRef/imagePullSecret/Job resources; no business Deployment rollout
