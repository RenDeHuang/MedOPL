...
-> materialize static Package D runner manifest review pack / authorization pack / bootstrap authorization pack; then run authorized Kubernetes API connectivity and server-side dry-run from a Tencent CloudShell, Cloud Assistant session or VPC internal runner with TKE API reachability
