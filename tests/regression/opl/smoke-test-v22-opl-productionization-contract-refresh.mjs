...
const files = {
  ...
  mvpSuite: "tests/contract/smoke-test-v22-mvp-contract-suite.mjs",
};
...
assertIncludesAll(contents.gapMatrix, [
  ...
  "eval: `node tests/regression/opl/smoke-test-v22-opl-productionization-contract-refresh.mjs`, `node tests/regression/opl/smoke-test-v22-opl-productionization-eval-shell.mjs`",
...
assert(
  isSmokeClassifiedIn("tests/regression/opl/smoke-test-v22-opl-productionization-contract-refresh.mjs"),
  "mvp_suite_leaf6_missing:tests/regression/opl/smoke-test-v22-opl-productionization-contract-refresh.mjs",
);
