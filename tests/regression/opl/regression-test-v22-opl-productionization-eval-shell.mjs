...
const files = {
  ...
  refreshGate: "tests/regression/opl/regression-test-v22-opl-productionization-contract-refresh.mjs",
  noFakeSuccessGate: "tests/regression/opl/regression-test-v22-real-opl-file-run-artifact-gates.mjs",
...
assertIncludesAll(contents.goalState, [
  ...
  "node tests/regression/opl/regression-test-v22-opl-productionization-eval-shell.mjs",
