...
assert.ok(isSmokeClassifiedIn("tests/regression/opl/smoke-test-v22-real-opl-capability-contract-gate.mjs"), "mvp_suite: missing tests/regression/opl/smoke-test-v22-real-opl-capability-contract-gate.mjs");
