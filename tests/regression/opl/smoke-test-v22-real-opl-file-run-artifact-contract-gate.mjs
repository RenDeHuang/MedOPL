...
assert.ok(isSmokeClassifiedIn("tests/regression/opl/smoke-test-v22-real-opl-file-run-artifact-contract-gate.mjs"), "mvp_suite: missing tests/regression/opl/smoke-test-v22-real-opl-file-run-artifact-contract-gate.mjs");
assert.equal(
  isSmokeClassifiedIn("tests/regression/opl/smoke-test-v22-real-opl-file-run-artifact-contract-gate.mjs"),
  false,
