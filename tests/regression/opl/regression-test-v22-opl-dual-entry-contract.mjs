...
assert(
  isSmokeClassifiedIn("tests/regression/opl/regression-test-v22-opl-dual-entry-contract.mjs"),
  "mvp_contract_suite_must_include_dual_entry_smoke",
);

assert(
  isSmokeClassifiedIn("tests/regression/opl/regression-test-v22-opl-gateway-upstream-proxy-local.mjs"),
