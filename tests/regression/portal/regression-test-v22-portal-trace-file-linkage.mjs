...
const db = {
  ...
  workspaceFiles: [{
    ...
    id: "artifact-v22-trace-file-other-owner",
    tenantId: user.tenantId,
    userId: user.id,
    ownerId: "other-owner",
    storageOwnerId: "other-owner",
    workspaceId,
    runId,
    oplSessionId: sessionId,
    resourceBindingId: "binding-v22-trace-file",
    kind: "outputs",
    name: "other-owner-result.md",
    relativePath: `${runId}/other-owner-result.md`,
    sizeBytes: 512,
    contentType: "text/markdown",
    status: "active",
    source: "runtime_bridge_artifact_reference",
    createdAt: "2026-05-08T08:01:30.000Z",
    updatedAt: "2026-05-08T08:02:30.000Z",
  }],
};
...
const tracePayload = await buildSessionTracesApiPayload({
  fetchRuntimeBridgeTraceRows: async () => ({
    ...
    rows: [{
      ...
      traceId: "trace-v22-file-linkage-other-owner",
      traceName: "其他 owner 输出文件关联",
      userId: user.id,
      ownerId: "other-owner",
      traceOwnerId: "other-owner",
      workspaceId,
      workspaceSessionId: "workspace-session-v22-trace-file",
      runtimeSessionId: sessionId,
      sessionId,
      runId,
      status: "succeeded",
      startedAt: "2026-05-08T08:01:30.000Z",
      source: "runtime_bridge",
      artifactRefs: ["artifact-v22-trace-file-other-owner"],
    }],
  }),
...
assert(isSmokeClassifiedIn("tests/regression/portal/regression-test-v22-portal-trace-file-linkage.mjs"), "mvp_suite_must_include_trace_file_linkage_smoke");
