...
assert(isSmokeClassifiedIn("tests/regression/portal/regression-test-v22-managed-resource-binding-plan-view.mjs"), "mvp_suite_must_include_managed_plan_view_smoke");
