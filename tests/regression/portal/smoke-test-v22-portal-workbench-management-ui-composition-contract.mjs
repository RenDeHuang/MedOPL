...
const runtimeSuite = await source("tests/regression/portal/smoke-test-v22-portal-runtime-suite.mjs");
...
assert.equal(contract.surfaceSmoke.smoke, "tests/regression/portal/smoke-test-v22-portal-frontend-surface-eval.mjs", "surface_smoke_mismatch");
...
assertIncludes(runtimeSuite, "tests/regression/portal/smoke-test-v22-portal-frontend-surface-eval.mjs", "runtime_suite_must_include_surface_eval");
assertIncludes(runtimeSuite, "tests/regression/portal/smoke-test-v22-portal-figma-make-admin-readiness.mjs", "runtime_suite_must_include_admin_readiness");
assertIncludes(runtimeSuite, "tests/regression/portal/smoke-test-v22-portal-web-route-alignment.mjs", "runtime_suite_must_include_route_alignment");
