...
assert(!apiClientSource.includes("export const apiClient"), "retired_portal_api_client_must_not_return");
assert(!apiClientSource.includes('baseURL: "/portal/api"'), "retired_portal_api_base_must_not_return");
assert(apiClientSource.includes("goControlPlaneClient.interceptors.response.use"), "portal_frontend_api_client_must_handle_auth_response_boundary");
...
const dispatcher = createPortalHttpDispatcher({
  ...
  handlePortalWorkspaceRoutes: async () => false,
