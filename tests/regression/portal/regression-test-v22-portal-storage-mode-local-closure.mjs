...
const runtimeSuiteEntrypoint = path.join(repoRoot, "tests", "regression", "portal", "regression-test-v22-portal-runtime-suite.mjs");
...
async function assertRepoStorageContracts() {
  ...
  assert(runtimeSuiteSource.includes("regression-test-v22-portal-storage-mode-local-closure.mjs"), "runtime_suite_must_include_storage_mode_smoke");
}
