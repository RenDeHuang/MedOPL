...
assert(isSmokeClassifiedIn("tests/regression/portal/smoke-test-v22-portal-cost-balance-trace-linkage.mjs"), "mvp_suite_must_include_cost_balance_trace_linkage_smoke");
