...
assertIncludesAll(contents.connection, [
  ...
  "历史授权 provider message live canary 脱敏 evidence 结论",
  "Portal -> Gateway -> Runtime Bridge -> clean OPL WebUI bridge -> provider message 曾观测到真实 assistant reply",
  "`capabilitySource=mapped_to_webui_bridge`",
  "该 evidence 只证明当次授权路径的 provider message/reply",
