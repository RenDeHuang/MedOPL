...
const allEvalScripts = await listTestFiles(testsRoot);
...
assert(defaultScripts.includes("tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs"), "default_suite_must_run_archive_physical_retirement_gate");
...
const mvpSuiteSource = await readFile(path.join(repoRoot, "tests/contract/contract-test-v22-mvp-contract-suite.mjs"), "utf8");
