...
const thisGate = "tests/contract/smoke-test-v22-monolith-agent-workflow-entrypoint-and-trace-normalization.mjs";
...
const portalRuntimeMetadata = smokeEvalMetadataOf("tests/regression/portal/smoke-test-v22-portal-runtime-suite.mjs");
const cloudResourceMetadata = smokeEvalMetadataOf("tests/future-authorized/cloud/smoke-test-v22-cloud-resource-contract-suite.mjs");
...
assert(classificationText.includes("tests/contract/smoke-test-v22-monolith-agent-workflow-entrypoint-and-trace-normalization.mjs"), "this_gate_must_be_classified");
...
assert(override.commands.includes("node tests/contract/smoke-test-v22-agent-run-record-gate.mjs"), "branch_override_must_run_agent_record_gate");
...
assert(override.allowed_files.includes("tests/health/smoke-test-v22-smoke-eval-boundary.mjs"), "branch_override_must_allow_smoke_eval_boundary");
assert(override.allowed_files.includes("tests/health/smoke-test-v22-contract-conflict-boundary.mjs"), "branch_override_must_allow_contract_conflict_gate");
assert(override.allowed_files.includes("tests/contract/smoke-test-v22-contract-smoke-eval-index-compaction.mjs"), "branch_override_must_allow_contract_smoke_eval_index_compaction_gate");
assert(override.allowed_files.includes("tests/regression/portal/smoke-test-v22-observability-billing-narrative-boundary.mjs"), "branch_override_must_allow_observability_billing_gate");
assert(override.allowed_files.includes("tests/contract/smoke-test-v22-truth-repo-narrative-reference-unification.mjs"), "branch_override_must_allow_truth_repo_narrative_gate");
assert(override.allowed_files.includes("tests/health/smoke-test-v22-zero-compat-active-surface-gate.mjs"), "branch_override_must_allow_zero_compat_gate");
