...
const smokeEvalScripts = files.filter((file) => /^tests\/.+\/smoke-test-v22-.+\.mjs$/u.test(file));
...
const metadata = smokeEvalMetadataOf("tests/contract/smoke-test-v22-contract-smoke-eval-index-compaction.mjs");
...
].sort(), "suite_wrappers_must_remain_explicit");
assert.deepEqual(
  smokeEvalScripts
...
assert(override.commands.includes("node tests/contract/smoke-test-v22-contract-smoke-eval-index-compaction.mjs"), "branch_override_must_run_this_gate");
assert(override.commands.includes("node tests/health/smoke-test-v22-smoke-classification-gate.mjs"), "branch_override_must_run_classification_gate");
assert(override.commands.includes("node tests/health/smoke-test-v22-smoke-eval-boundary.mjs"), "branch_override_must_run_boundary_gate");
...
assert(localContract.commands.includes("node tests/contract/smoke-test-v22-contract-smoke-eval-index-compaction.mjs"), "local_contract_suite_must_include_this_gate");
