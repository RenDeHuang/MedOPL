...
const gatePath = "tests/contract/contract-test-v22-product-goal-harness.mjs";
const executionOrderGatePath = "tests/contract/contract-test-v22-product-goal-execution-order.mjs";
const consistencyGatePath = "tests/contract/contract-test-v22-goal-state-consistency.mjs";
...
const controlPlaneConsolidationPhrases = [
  ...
  "spec:v22-goal-state 降级为 human summary / history",
...
const requiredValidationCommands = [
  ...
  "node tests/contract/contract-test-v22-product-goal-execution-order.mjs",
