...
const branchScopedAllowedDiffPaths = new Map([
  ...
  ["feat/v22-opl-productionization-local-implementation", new Set([
    ...
    "docs/recovery/v22-current-vs-ideal-gap-matrix.md",
    "docs/recovery/v22-goal-state.md",
    "tests/regression/opl/regression-test-v22-opl-productionization-eval-shell.mjs",
    "tests/contract/contract-test-v22-product-goal-harness.mjs",
    "tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs",
  ...
  ["docs/v22-advance-opl-productionization-eval-shell-cursor", new Set([
    "docs/recovery/v22-current-vs-ideal-gap-matrix.md",
    "docs/recovery/v22-goal-state.md",
    "tests/regression/opl/regression-test-v22-opl-productionization-contract-refresh.mjs",
    "tests/regression/opl/regression-test-v22-opl-productionization-eval-shell.mjs",
    "tests/contract/contract-test-v22-product-goal-harness.mjs",
    "tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs",
  ])],
  ...
  ["cleanup/v22-retire-resource-order-store-admin-frontend", new Set([
    ...
    "tests/regression/portal/regression-test-v22-admin-ops-console-readonly-mvp.mjs",
...
function assertDefaultTruthDocs({ readme, product, architecture }) {
  ...
  assertIncludes(readme, "tests/contract/contract-test-v22-default-entry-narrative-gate.mjs", "readme_default_entry_gate");
