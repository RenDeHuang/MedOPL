...
const thisGate = "tests/contract/smoke-test-v22-docs-taxonomy-skeleton.mjs";
...
assert(override.commands.includes("node tests/health/smoke-test-v22-smoke-eval-boundary.mjs"), "branch_override_must_run_smoke_eval_boundary_gate");
...
assert(override.commands.includes("node tests/contract/smoke-test-v22-agent-verify-entrypoint.mjs"), "branch_override_must_run_agent_verify_entrypoint");
