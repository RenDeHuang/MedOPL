...
const files = {
  ...
  productHarness: "tests/contract/contract-test-v22-product-goal-harness.mjs",
...
assert(portalUiTruthOverride.commands.includes("node tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs"), "portal_ui_truth_convergence_override_must_include_retired_frontend_gate");
...
assertNotIncludes(strictCleanupOverride.commands.join("\n"), "node tests/regression/portal/regression-test-v22-portal-ui-design-quality-audit.mjs", "strict_monolith_cleanup_override_must_not_run_ui_authoring_gate");
assert(strictCleanupOverride.commands.includes("node tests/regression/portal/regression-test-v22-observability-billing-narrative-boundary.mjs"), "strict_monolith_cleanup_override_must_include_observability_boundary");
assert(strictCleanupOverride.commands.includes("node tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs"), "strict_monolith_cleanup_override_must_include_archive_physical_retirement_gate");
...
assertIncludes(
  await readRepoFile("tests/contract/contract-test-v22-mvp-contract-suite.mjs"),
...
assert(contractIndexCleanupOverride.commands.includes("node tests/smoke/smoke-test-v22-saas-control-plane-user-experience-boundary.mjs"), "contract_index_cleanup_override_must_include_ux_boundary");
assert(contractIndexCleanupOverride.commands.includes("node tests/health/health-check-v22-zero-compat-active-surface-gate.mjs"), "contract_index_cleanup_override_must_include_zero_compat_gate");
assert(contractIndexCleanupOverride.commands.includes("node tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs"), "contract_index_cleanup_override_must_include_archive_physical_retirement_gate");
assertNotIncludes(contractIndexCleanupOverride.commands.join("\n"), "node tests/regression/portal/regression-test-v22-portal-ui-design-quality-audit.mjs", "contract_index_cleanup_override_must_not_run_ui_authoring_gate");
...
assert.deepEqual(strictCleanupPlanPayload.commands, [
  "node tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs",
  "node tests/contract/contract-test-v22-default-entry-narrative-gate.mjs",
...
assert(contractIndexCleanupPlanPayload.commands.includes("node tests/smoke/smoke-test-v22-saas-control-plane-user-experience-boundary.mjs"), "verify_current_contract_index_cleanup_must_run_ux_boundary");
assert(contractIndexCleanupPlanPayload.commands.includes("node tests/health/health-check-v22-zero-compat-active-surface-gate.mjs"), "verify_current_contract_index_cleanup_must_run_zero_compat_gate");
assert(contractIndexCleanupPlanPayload.commands.includes("node tests/health/health-check-v22-archive-smoke-contract-physical-retirement-gate.mjs"), "verify_current_contract_index_cleanup_must_run_archive_physical_retirement_gate");
assertNotIncludes(
...
assert(contractSmokeEvalIndexCompactionOverride.commands.includes("node tests/contract/contract-test-v22-contract-smoke-eval-index-compaction.mjs"), "contract_smoke_eval_index_compaction_must_run_own_gate");
assert(contractSmokeEvalIndexCompactionOverride.commands.includes("node tests/health/health-check-v22-smoke-classification-gate.mjs"), "contract_smoke_eval_index_compaction_must_run_classification_gate");
assert(contractSmokeEvalIndexCompactionOverride.commands.includes("node tests/health/health-check-v22-smoke-eval-boundary.mjs"), "contract_smoke_eval_index_compaction_must_run_boundary_gate");
...
assert(post20fe9acOverride.commands.includes("node tests/contract/contract-test-v22-post-20fe9ac-agent-workflow-truth-and-repo-classification.mjs"), "post_20fe9ac_must_run_own_gate");
assert(post20fe9acOverride.commands.includes("node tests/contract/contract-test-v22-goal-state-consistency.mjs"), "post_20fe9ac_must_run_goal_state_gate");
assert(post20fe9acOverride.commands.includes("node tests/contract/contract-test-v22-agent-run-record-gate.mjs"), "post_20fe9ac_must_run_agent_record_gate");
...
assert(truthRepoOverride.commands.includes("node tests/contract/contract-test-v22-truth-repo-narrative-reference-unification.mjs"), "truth_repo_must_run_own_gate");
assert(truthRepoOverride.commands.includes("node tests/contract/contract-test-v22-post-20fe9ac-agent-workflow-truth-and-repo-classification.mjs"), "truth_repo_must_run_post_20fe9ac_gate");
assert(truthRepoOverride.commands.includes("node tests/contract/contract-test-v22-long-term-governance-surfaces.mjs"), "truth_repo_must_run_governance_gate");
assert(truthRepoOverride.commands.includes("node tests/contract/contract-test-v22-agent-run-record-gate.mjs"), "truth_repo_must_run_agent_record_gate");
...
assert(truthRepoOverride.allowed_files.includes("tests/contract/contract-test-v22-truth-repo-narrative-reference-unification.mjs"), "truth_repo_must_allow_gate");
...
assert(monolithEntryTraceOverride.commands.includes("node tests/contract/contract-test-v22-monolith-agent-workflow-entrypoint-and-trace-normalization.mjs"), "monolith_entry_trace_must_run_own_gate");
assert(monolithEntryTraceOverride.commands.includes("node tests/contract/contract-test-v22-agent-run-record-gate.mjs"), "monolith_entry_trace_must_run_agent_record_gate");
assert(monolithEntryTraceOverride.commands.includes("node tests/health/health-check-v22-smoke-classification-gate.mjs"), "monolith_entry_trace_must_run_classification_gate");
...
assert(monolithEntryTraceOverride.allowed_files.includes("tests/contract/contract-test-v22-monolith-agent-workflow-entrypoint-and-trace-normalization.mjs"), "monolith_entry_trace_must_allow_gate");
