...
const renamedLoopGate = "tests/smoke/smoke-test-v22-mvp-user-loop-contract.mjs";
...
assertIncludes(classification, `"${renamedLoopGate}": "default/local-contract"`, "scripts/v22-test-classification.mjs");
assertIncludes(classification, `"${renamedLoopGate}"`, "scripts/v22-test-classification.mjs");
assertNotIncludes(classification, retiredLoopGate, "scripts/v22-test-classification.mjs");
assertIncludes(
  classification,
...
[
  ...
  "node tests/contract/contract-test-v22-contract-eval-compaction.mjs",
