...
const thisGate = "tests/contract/smoke-test-v22-truth-repo-narrative-reference-unification.mjs";
...
const post20Gate = "tests/contract/smoke-test-v22-post-20fe9ac-agent-workflow-truth-and-repo-classification.mjs";
...
const smokeFiles = files.filter((file) => /^tests\/.+\/smoke-test-v22-.+\.mjs$/u.test(file));
