...
const metadata = smokeEvalMetadataOf("tests/contract/contract-test-v22-contract-smoke-eval-index-compaction.mjs");
...
assert(override.commands.includes("node tests/contract/contract-test-v22-contract-smoke-eval-index-compaction.mjs"), "branch_override_must_run_this_gate");
...
assert(override.commands.includes("node tests/health/health-check-v22-smoke-eval-boundary.mjs"), "branch_override_must_run_boundary_gate");
...
assert(localContract.commands.includes("node tests/contract/contract-test-v22-contract-smoke-eval-index-compaction.mjs"), "local_contract_suite_must_include_this_gate");
