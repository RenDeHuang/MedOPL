...
assert.equal(
  SMOKE_CLASSIFICATION["tests/contract/contract-test-v22-repo-governance-physical-compaction.mjs"],
  "default/local-contract",
  "repo_governance_gate_must_be_default_local_contract",
);
assert.equal(
  smokeEvalMetadataOf("tests/contract/contract-test-v22-repo-governance-physical-compaction.mjs").tier,
  "contract-local",
...
assert(override.commands.includes("node tests/contract/contract-test-v22-repo-governance-physical-compaction.mjs"), "repo_governance_override_must_run_gate");
...
assert(localContract.commands.includes("node tests/contract/contract-test-v22-repo-governance-physical-compaction.mjs"), "local_contract_suite_must_include_repo_governance_gate");
