...
const thisGate = "tests/contract/contract-test-v22-post-20fe9ac-agent-workflow-truth-and-repo-classification.mjs";
...
const goalGateSource = await source("tests/contract/contract-test-v22-goal-state-consistency.mjs");
for (const token of [
...
assert(override.commands.includes("node tests/contract/contract-test-v22-goal-state-consistency.mjs"), "post_20fe9ac_override_must_run_goal_state_gate");
assert(override.commands.includes("node tests/contract/contract-test-v22-agent-run-record-gate.mjs"), "post_20fe9ac_override_must_run_agent_record_gate");
