...
const branchScopedAllowedDiffPaths = new Map([
  ...
  ["feat/v22-opl-productionization-local-implementation", new Set([
    ...
    "docs/recovery/v22-current-vs-ideal-gap-matrix.md",
    "docs/recovery/v22-goal-state.md",
    "tests/regression/opl/smoke-test-v22-opl-productionization-eval-shell.mjs",
    "tests/contract/smoke-test-v22-product-goal-harness.mjs",
    "tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs",
  ...
  ["docs/v22-advance-opl-productionization-eval-shell-cursor", new Set([
    "docs/recovery/v22-current-vs-ideal-gap-matrix.md",
    "docs/recovery/v22-goal-state.md",
    "tests/regression/opl/smoke-test-v22-opl-productionization-contract-refresh.mjs",
    "tests/regression/opl/smoke-test-v22-opl-productionization-eval-shell.mjs",
    "tests/contract/smoke-test-v22-product-goal-harness.mjs",
    "tests/health/smoke-test-v22-archive-smoke-contract-physical-retirement-gate.mjs",
  ])],
  ...
  ["cleanup/v22-retire-resource-order-store-admin-frontend", new Set([
    ...
    "tests/regression/portal/smoke-test-v22-admin-ops-console-readonly-mvp.mjs",
    "tests/regression/portal/smoke-test-v22-portal-admin-shared-helper-structure.mjs",
...
const branchScopedAllowedDiffPatterns = new Map([
  ...
  ["cleanup/v22-archive-smoke-contract-physical-retirement", [
    "AGENTS.md",
    "OPL-v20-*",
    "docs/status.md",
    "docs/contracts/README.md",
...
function assertDefaultTruthDocs({ readme, product, architecture }) {
  ...
  assertIncludes(readme, "tests/contract/smoke-test-v22-default-entry-narrative-gate.mjs", "readme_default_entry_gate");
