...
assert.deepEqual(autonomousSuite.commands, [
  "node tests/contract/smoke-test-v22-autonomous-goal-runner.mjs",
...
assert(manifest.control_plane_files.includes("tests/contract/smoke-test-v22-autonomous-goal-runner.mjs"), "manifest_control_plane_smoke_missing");
