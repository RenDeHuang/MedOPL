...
const thisGate = "tests/contract/smoke-test-v22-opl-style-taxonomy-hard-compaction.mjs";
...
assert(override.commands.includes("node tests/contract/smoke-test-v22-docs-taxonomy-skeleton.mjs"), "hard_compaction_override_must_run_taxonomy_gate");
assert(override.commands.includes("node tests/contract/smoke-test-v22-agent-run-record-gate.mjs"), "hard_compaction_override_must_run_agent_record_gate");
