...
const allowedOldLiteralFiles = new Set([
  ...
  "tests/governance/governance-test-v22-agent-verify-entrypoint.mjs",
  "tests/governance/governance-test-v22-current-state-index-loop.mjs",
  "tests/governance/governance-test-v22-full-taxonomy-cleanup.mjs",
