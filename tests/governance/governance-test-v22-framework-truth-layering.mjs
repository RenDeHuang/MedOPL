...
assert(reviewSuite?.commands.includes("node tests/governance/governance-test-v22-framework-truth-layering.mjs"), "review_suite_must_run_framework_truth_layering");
assert(localContractSuite?.commands.includes("node tests/governance/governance-test-v22-framework-truth-layering.mjs"), "local_contract_must_run_framework_truth_layering");
