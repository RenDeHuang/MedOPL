...
assert.equal(currentLeaf.verification_commands[0], "node tests/suites/suite-test-v22-golden-smoke.mjs", "current_leaf_must_start_with_golden_path_health");
assert.equal(current.current_leaf.verification_commands[0], "node tests/suites/suite-test-v22-golden-smoke.mjs", "current_fixture_must_start_with_golden_path_health");
...
assert(override.commands.includes("node tests/governance/governance-test-v22-framework-workflow-convergence.mjs"), "framework_workflow_override_must_run_gate");
...
assert(cleanupPayload.commands.includes("node tests/governance/governance-test-v22-framework-workflow-convergence.mjs"), "cleanup_plan_must_run_gate");
...
if (productLoop.status === "closed") {
  ...
  assert(productLoopOverride.commands.includes("node tests/governance/governance-test-v22-product-engineering-loop-index.mjs"), "product_engineering_loop_index_override_must_run_gate");
  ...
  assert(productLoopPayload.commands.includes("node tests/governance/governance-test-v22-product-engineering-loop-index.mjs"), "product_loop_plan_must_run_gate");
}
