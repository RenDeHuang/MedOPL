...
const rcEvidence = [
  "tests/contracts/contract-test-v22-local-service-orchestration.mjs",
...
assertRegistered("tests/governance/governance-test-v22-local-saas-backend-rc.mjs", {
  surface: "control-plane",
  category: "default/local-contract",
  entryKind: "gate-self-test",
});
assertSuiteContains("current", "tests/governance/governance-test-v22-local-saas-backend-rc.mjs");
assertSuiteContains("local-contract", "tests/governance/governance-test-v22-local-saas-backend-rc.mjs");
assertSuiteContains("review", "tests/governance/governance-test-v22-local-saas-backend-rc.mjs");
...
assertIncludes(current.current_leaf.verification_commands.join("\n"), "node tests/governance/governance-test-v22-local-saas-backend-rc.mjs", "machine_current_leaf_must_run_local_saas_backend_rc");
assertIncludes(manifest.suites.find((suite) => suite.id === "current").commands.join("\n"), "node tests/governance/governance-test-v22-local-saas-backend-rc.mjs", "manifest_current_suite_must_run_local_saas_backend_rc");
assertIncludes(manifest.suites.find((suite) => suite.id === "review").commands.join("\n"), "node tests/governance/governance-test-v22-local-saas-backend-rc.mjs", "manifest_review_suite_must_run_local_saas_backend_rc");
