...
const selfFile = "tests/governance/governance-test-v22-ai-mvp-readiness-audit.mjs";
...
const requiredLocalProofs = Object.freeze([
  "tests/suites/suite-test-v22-mvp.mjs",
  "tests/contracts/contract-test-v22-precloud-deployable-rc.mjs",
  "tests/governance/governance-test-v22-local-portal-opl-delivery-rc.mjs",
...
assert(
  TEST_LANE_SUITES["local-contract"].includes("tests/contracts/runtime-bridge/contract-test-v22-ai-runtime-contract.mjs"),
  "ai_runtime_contract_gate_must_be_local_contract_registry_member",
);
...
assert(
  TEST_LANE_SUITES["local-contract"].includes(selfFile),
  "ai_runtime_eval_plan_ai_mvp_readiness_must_be_current_registry_gate",
);
