...
const physicalRemovalGate = "node tests/contracts/contract-test-v22-node-portal-backend-physical-removal.mjs";
const groupGateCommands = [
  "node tests/governance/governance-test-v22-backend-go-convergence-program.mjs",
  physicalRemovalGate,
  "node tests/contracts/contract-test-v22-go-backend-service-surface.mjs",
  "node tests/governance/governance-test-v22-commercial-package-model.mjs",
];
...
for (const [label, suite] of [["backend_suite", backendSuite], ["backend_package", backendPackage]]) {
  ...
  assertCommandListExcludes(suite.commands, [
    "node tests/contracts/contract-test-v22-node-portal-workflow-facade-boundary.mjs",
  ], `manifest_${label}`);
}
...
assertIncludes(classifierSource, "\"tests/governance/governance-test-v22-backend-go-convergence-program.mjs\"", "test_registry_must_register_program_gate");
assertIncludes(classifierSource, "\"tests/contracts/contract-test-v22-node-portal-backend-physical-removal.mjs\"", "test_registry_must_register_physical_removal_gate");
