...
assert(productSuite.commands.includes("node tests/governance/governance-test-v22-product-engineering-loop-index.mjs"), "product_loop_suite_must_run_index_gate");
...
if (loop.status === "closed") {
  ...
  assert(branchOverride.commands.includes("node tests/governance/governance-test-v22-product-engineering-loop-index.mjs"), "product_engineering_loop_branch_override_must_run_gate");
...
for (const suite of [currentSuite, localContractSuite, reviewSuite]) {
  ...
  assert(suite.commands.includes("node tests/governance/governance-test-v22-product-engineering-loop-index.mjs"), `suite_must_run_product_loop_gate:${suite?.id}`);
}
...
assert(currentLeaf.verification_commands.includes("node tests/governance/governance-test-v22-product-engineering-loop-index.mjs"), "current_leaf_must_run_product_loop_gate");
