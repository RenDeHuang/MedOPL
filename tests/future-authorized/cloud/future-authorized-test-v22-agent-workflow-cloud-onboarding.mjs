...
assert.deepEqual(statusPayload.requiredSmoke, [
  ...
  "tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-worker-entrypoint.mjs",
...
assert(checkConfigPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-tencent-readonly-inventory-local-guard.mjs"), "check_config_smoke_command");
assert(checkConfigPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-tencent-readonly-inventory-official-sdk-shape.mjs"), "check_config_shape_smoke_command");
...
assert(harnessPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-cloud-harness-manifest-selector.mjs"), "harness_packet_must_include_manifest_selector_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/regression/portal/regression-test-v22-portal-runtime-startup-config.mjs"), "harness_packet_must_include_l1_runtime_config_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-cloud-cleanup-local-gate.mjs"), "harness_packet_must_include_cleanup_gate_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-worker-entrypoint.mjs"), "harness_packet_must_include_worker_entrypoint_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-async-worker-loop.mjs"), "harness_packet_must_include_async_worker_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/future-authorized/cloud/future-authorized-test-v22-portal-package-click-cloud-resource-loop.mjs"), "harness_packet_must_include_package_click_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/smoke/smoke-test-v22-release-stop-billing-audit-flow.mjs"), "harness_packet_must_include_l3_release_billing_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/smoke/smoke-test-v22-portal-files-billing-trace-flow.mjs"), "harness_packet_must_include_l3_files_billing_trace_smoke");
assert(harnessPacket.suggestedCommands.includes("node tests/regression/portal/regression-test-v22-portal-frontend-surface-eval.mjs"), "harness_packet_must_include_l4_frontend_surface_smoke");
...
const suite = await readFile(path.join(repoRoot, "tests/contract/contract-test-v22-mvp-contract-suite.mjs"), "utf8");
assert(suite.includes("future-authorized-test-v22-agent-workflow-cloud-onboarding.mjs"), "mvp_suite_must_include_cloud_onboarding_agent_workflow_smoke");
