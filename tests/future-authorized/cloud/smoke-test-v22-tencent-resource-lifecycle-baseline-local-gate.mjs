...
assert.equal(manifest.includes("tests/future-authorized/cloud/smoke-test-v22-tencent-resource-lifecycle-baseline-local-gate.mjs"), true, "manifest_must_reference_local_baseline_gate");
