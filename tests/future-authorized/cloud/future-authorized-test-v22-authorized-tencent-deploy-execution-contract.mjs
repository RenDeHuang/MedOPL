...
assert.equal(deployData.runner?.localGateSmoke, "tests/future-authorized/cloud/future-authorized-test-v22-tencent-deploy-execution-config-local-gate.mjs", "deploy_local_gate_smoke");
...
assert(suite.includes("future-authorized-test-v22-authorized-tencent-deploy-execution-contract.mjs"), "suite_must_include_deploy_contract_smoke");
...
assert(suite.includes("future-authorized-test-v22-tencent-deploy-execution-config-local-gate.mjs"), "suite_must_include_deploy_live_gate_smoke");
