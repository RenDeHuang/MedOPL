...
assert.equal(deployData.runner?.localGateSmoke, "tests/future-authorized/cloud/smoke-test-v22-tencent-deploy-execution-config-local-gate.mjs", "deploy_local_gate_smoke");
