...
assertIncludesAll(sequence, [
  ...
  "node tests/future-authorized/cloud/future-authorized-test-v22-portal-cloud-operation-test-api-local-gate.mjs",
  "node tests/future-authorized/cloud/future-authorized-test-v22-cloud-connection-runnable-path.mjs",
  "node tests/future-authorized/cloud/future-authorized-test-v22-tencent-readonly-inventory-official-sdk-loader.mjs",
  "future-authorized Package C resource lifecycle runner",
  "node tests/future-authorized/cloud/future-authorized-test-v22-authorized-tencent-deploy-execution-contract.mjs",
  "node tests/future-authorized/cloud/future-authorized-test-v22-cloud-onboarding-absorption-sequence.mjs",
...
assert(suite.includes("future-authorized-test-v22-cloud-onboarding-absorption-sequence.mjs"), "suite_must_include_absorption_sequence_smoke");
assert(suite.includes("future-authorized-test-v22-portal-cloud-operation-async-worker-loop.mjs"), "suite_must_include_portal_cloud_async_worker_loop_smoke");
