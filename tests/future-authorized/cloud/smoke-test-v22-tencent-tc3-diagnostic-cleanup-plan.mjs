...
const smokePath = "tests/future-authorized/cloud/smoke-test-v22-tencent-tc3-diagnostic-cleanup-plan.mjs";
...
assert(suite.includes("smoke-test-v22-tencent-tc3-diagnostic-cleanup-plan.mjs"), "mvp_suite_must_include_tc3_cleanup_plan_smoke");
