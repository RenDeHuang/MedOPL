...
assert.equal(l2b.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-portal-cloud-operation-async-worker-loop.mjs"), true, "l2b_async_worker_smoke_required");
assert.equal(l2b.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-tencent-resource-lifecycle-baseline-local-gate.mjs"), true, "l2b_baseline_snapshot_smoke_required");
...
assert.equal(l2a.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-tencent-resource-lifecycle-baseline-local-gate.mjs"), true, "l2a_baseline_snapshot_smoke_required");

const l3 = manifest.gates.find((gate) => gate.id === "L3");
assert.equal(l3.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-tencent-resource-lifecycle-baseline-local-gate.mjs"), true, "l3_baseline_snapshot_smoke_required");
...
assert.equal(selection.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-portal-cloud-operation-worker-entrypoint.mjs"), true, "selector_must_require_worker_entrypoint_smoke");
assert.equal(selection.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-portal-cloud-operation-async-worker-loop.mjs"), true, "selector_must_require_async_worker_smoke");
assert.equal(selection.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-cloud-cleanup-local-gate.mjs"), true, "selector_must_require_cleanup_gate");
assert.equal(selection.requiredSmoke.includes("tests/future-authorized/cloud/smoke-test-v22-tencent-resource-lifecycle-baseline-local-gate.mjs"), true, "selector_must_require_baseline_snapshot_smoke");
