...
assert(suite.includes("future-authorized-test-v22-tencent-readonly-inventory-official-sdk-loader.mjs"), "mvp_suite_must_include_official_sdk_loader_smoke");
assert(suite.includes("future-authorized-test-v22-tencent-tc3-diagnostic-cleanup-plan.mjs"), "mvp_suite_must_keep_tc3_cleanup_smoke");
