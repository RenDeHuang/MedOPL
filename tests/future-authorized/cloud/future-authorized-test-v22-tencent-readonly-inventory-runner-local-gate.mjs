...
import { parseReadonlyInventorySecretFile } from "../../../scripts/v22-tencent-readonly-inventory-runner.mjs";

const runnerPath = "scripts/v22-tencent-readonly-inventory-runner.mjs";
const smokePath = "tests/future-authorized/cloud/future-authorized-test-v22-tencent-readonly-inventory-runner-local-gate.mjs";
...
try {
  ...
  assert(suite.includes("future-authorized-test-v22-tencent-readonly-inventory-runner-local-gate.mjs"), "mvp_suite_must_include_live_runner_smoke");
} finally {
