        ...
        items: [
          {
            ...
            Tags: ownershipTags({
              ...
              billingAttributionId: "billing-002",
            }),
          },
        ],
        NextToken: "",
...
assert(suite.includes("future-authorized-test-v22-tencent-readonly-inventory-official-sdk-wrapper.mjs"), "mvp_suite_must_include_official_sdk_wrapper_smoke");
