...
assert.equal(workflow.portalApiTestBridge?.runnerMode, "local-executor", "portal_api_test_bridge_runner_mode");
...
assert(suite.includes("future-authorized-test-v22-cloud-onboarding-workflow-contract.mjs"), "mvp_suite_must_include_cloud_onboarding_workflow_smoke");
