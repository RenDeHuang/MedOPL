...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| `portal` | SaaS Portal 控制面 | `app=portal` | `portal` | `uswccr.ccs.tencentyun.com/gaofenglab/portal-opl` | `opl-v4` | `PORT=17080`；并引用 `portal-platform-config`、`portal-platform-secrets` | `100m` | `400m` | `192Mi` | `384Mi` | `http / TCP / 17080` | `portal` | `ClusterIP` | `TCP / 容器端口 17080 / 服务端口 17080 / http` |
