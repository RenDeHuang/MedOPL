...
| `evidence:local-provider-bound-message-proof` | Runtime | `docs/evidence/README.md`, `docs/specs/README.md`, `docs/history/README.md` | `node tests/contract/contract-test-v22-node-portal-backend-physical-removal.mjs`; `node tests/contract/contract-test-v22-precloud-deployable-rc.mjs` | historical local RC proof with current deterministic guards | Historical local provider-bound proof is current production provider, live external, deploy, real cloud or billing evidence. |
