...
export const TENCENT_CLOUD_SECRET_ID = String(process.env.TENCENT_CLOUD_SECRET_ID || "").trim();
export const TENCENT_CLOUD_SECRET_KEY = String(process.env.TENCENT_CLOUD_SECRET_KEY || "").trim();
...
export const TENCENT_TKE_NODE_IMAGE_ID = String(process.env.TENCENT_TKE_NODE_IMAGE_ID || process.env.TENCENT_PRICE_IMAGE_ID || "").trim();
