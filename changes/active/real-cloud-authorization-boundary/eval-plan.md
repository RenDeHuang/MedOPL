...
- Package D deploy readiness planning has a local gate for cluster `cls-fi097sy4`, platform pool `np-cbk784r8`, VPC PostgreSQL `10.66.0.21:5432`, deploy secret/env allowlist and readiness gaps.
...
- Package D readiness planning does not authorize deploy execution, kubeconfig read, kubectl, build/push or DB writes.
