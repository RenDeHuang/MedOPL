...
- [x] Step 0: baseline audit of current Package B and TC3 cleanup state.
- [x] Step 1: add Package C dry-run local gate.
- [x] Step 2: add Package C dry-run runner.
- [x] Step 3: register the gate in test classification and verify manifest.
- [x] Step 4: update specs narrative for the Package C dry-run boundary.
