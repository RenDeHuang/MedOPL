...
- [ ] Step 1: open this change package and register the non-cloud Portal/OPL delivery boundary.
- [ ] Step 2: add local release orchestration commands for plan/check/start/stop/status/logs.
- [ ] Step 3: add local persistent state profile for Portal delivery without adding a second control plane.
