...
- repo health context, when explicitly requested
...
- AI MVP readiness can be audited as local contract evidence across MVP suite, pre-cloud RC, local Portal/OPL delivery RC, AI Runtime Contract, Runtime Bridge local E2E proofs and real-cloud authorization blocker.
