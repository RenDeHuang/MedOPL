...
export const RUNTIME_BRIDGE_PREFIX = "/runtime-bridge";
...
export function buildStatusPayload() {
  return {
    ...
    gatewayInteractionTargets: {
      timingMarkers: ["portal_launch_ready_ms", "opl_dom_ready_ms", "opl_first_interaction_ms"],
      domReadyMs: 5000,
      firstInteractionMs: 8000,
      firstReplyMs: 10000,
    },
    runtime: {
