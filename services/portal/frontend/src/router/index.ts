...
const routes: RouteRecordRaw[] = [
  ...
  { path: "/__portal-harness/components", name: "portal-harness-components", component: () => import("@/views/harness/PortalComponentWorkbenchView.vue") },
  { path: "/__portal-harness/components/:componentId/:state", name: "portal-harness-component-state", component: () => import("@/views/harness/PortalComponentWorkbenchView.vue") },
